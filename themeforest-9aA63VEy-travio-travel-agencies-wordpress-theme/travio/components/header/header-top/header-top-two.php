<?php
$header_top_bar_email   = travio_get_options( 'header_top_bar_email' );
$header_top_bar_address = travio_get_options( 'header_top_bar_address' );
$header_top_bar_phone   = travio_get_options( 'header_top_bar_phone' );
$header_top_bar_social  = travio_get_options( 'header_top_bar_social' );
?>
	...
	<div class="auto-container">
		<div class="top-inner clearfix">
			...
			<ul class="social-links pull-right clearfix">
				<?php echo wp_kses( $header_top_bar_social, 'travio_kses' ); ?>
			</ul>
			<?php endif; ?>
		</div>
	</div>
